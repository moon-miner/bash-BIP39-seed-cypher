...
show_usage() {
    ...
    cat << EOF
Usage: ${script_name} [-f 'output filename'] [word1 word2 word3 ... | seedfile.txt]
...
Examples:
    ${script_name} word1 word2 word3 ...
    ${script_name} -f mycodedseed word1 word2 word3 ...
    ${script_name} mycodedseed.txt

EOF

    # ASCII art permanece igual
    cat << 'EOF'
                                  000000000
                              000000000000000000
                            000000          000000
